...
---küsib Gender ja department ID ning kuvab  andmed tabelist
...
--küsib gender ja arvutab töötajad arvu ID järgi
...
---arvutab töötajate arv ja anna nime @totalcount
...
--- küsib id, ja naitab Eesnimi ID järgi 
