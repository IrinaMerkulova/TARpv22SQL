...
-- näitab, kas meilidel pole @-märki
...
--- näitab rida, kus linn on Gotham või New York ja veerus AGE vanus >= 40
...
--- näitab vanuse järgi järjestatud 3 parimat nime
select * from Person
select top 3 Age, Name from Person

--- näitab 50 protsenti andmetest
select top 50 percent * from Person
--näitab sorteerimist nime järgi
...
--lisab veeru MiddleName tabelisse Employees
alter table Employees
