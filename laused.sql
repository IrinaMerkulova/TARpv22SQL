...
--- Näitab linnu, mis algavad tähega "n" ja näitab kirja, mis sisaldab "@"
select * from Person where City like 'n%'
select * from Person where Email like '%@%'

-- Näitab kirja, mis sisaldab "@"
...
--- näita kirjeid, kus City = "Gotham" või City = "New York" ja kus vanus on suurem või võrdne 40
...
--- Kuvab tabeli "Isik" ja kuvab 3 suurimat vanust
select * from Person
select top 3 Age, Name from Person

--- näitab poolt tabelist "Person".
select top 50 percent * from Person
--sorteerib tabeli "Isik", kasutades konversiooni Age int ja lihtsalt tavalist sortimist
select * from Person order by cast(Age as int)
select * from Person order by Age

--? casst - teiseldab int andmetüüpiks
