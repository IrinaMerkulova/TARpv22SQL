...
--- kustutab  teisese võtme
alter table Person
drop constraint tblPerson_GenderId_FK

-- Lisab Unkown gender Gender tabelisse
insert into Gender (Id, Gender)
values (3, 'Unknown')
...
--annab vae, sest vanus ei saa olla rohkem >160
...
--tabeli uuendamine
update Person SET City='Gothman'
WHERE id=1
...
-- näitab inimesed vanusege 100 või 50 või 20
select *from Person where Age = 100 or 
Age = 50 or Age = 20
select * from Person where Age in (100, 50, 20)


--- näitab inimesi, kes on linnas n ja inimesi, kelle meilisõnum sisaldab @	
select * from Person where City like 'n%'
select * from Person where Email like '%@%'

-- näitab inimesed, kelle meilis @ pole
...
--- näitab esimese 3 inimese nimesid ja vanust
select * from Person
